...
class CustomDialog(QDialog):
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon(f"res/{get_os_theme()}/settings.ico"))
        self.setModal(True)
        self.resize(600, 500)
...
#### Program Settings ####
        ...
        program_layout.addWidget(self.debug_mode_check)
...
#### BUTTONS ####
    ...
    def settingsChangeFontSize(value):
    ...
    def load_settings(self, reset = None):
        ...
        remember_debugmode = settings_manager.get('SETTINGS/DebugMode')
        self.debug_mode_check.setChecked(remember_debugmode.lower() == 'true')
    ...
    def save_settings(self):
        ...
        remember_debugmode = self.debug_mode_check.isChecked()
        ...
        settings_manager.set('SETTINGS/DebugMode', remember_debugmode)
